...
class Submission(models.Model):
    ...
    message = models.TextField(blank=True, null=True, help_text='If you\'d like, leave a private message to Denny, Josh, and Jake (not public)')
    name = models.CharField(max_length=200,blank=True, null=True,
            help_text="<b>Your Name, Location</b> would be ideal")
    email = models.CharField(max_length=200,blank=True, null=True, help_text="Give us a way to contact you (not public)")

    text = models.TextField(blank=True, help_text='A story about how Barbara touched your life, or anything else you want to share. <small>(markdown formatting available)</small>')
